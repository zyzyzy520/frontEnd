...
2. 组件被称为"状态机", 通过**`更新组件的state来更新对应的页面显示`**(`重新渲染组件`)
...
- 在组件标签内用ref标识(类似于id)
- 在函数内用this.refs获取，并用解构赋值获取到具体的节点信息

![image-20220125104840286](C:\Users\zayn\AppData\Roaming\Typora\typora-user-images\image-20220125104840286.png)
